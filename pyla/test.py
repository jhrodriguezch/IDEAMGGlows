...
rp_nivel_de_alerta_bajos_obs, _ = pyla.get_return_period_from_data(data = nivel_de_alerta_bajos_obs,    time_serie = min_anual_data_obs.data.values.tolist())
nivel_de_alerta_bajos_sim, _    = pyla.get_data_from_return_period(rp   = rp_nivel_de_alerta_bajos_obs, time_serie = min_anual_data_sim.data.values.tolist())
